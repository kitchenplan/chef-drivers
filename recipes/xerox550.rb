remote_file "#{Chef::Config[:file_cache_path]}/FIT224989_mac10.10_.zip" do
    ...
    not_if do ::File.exists?("#{Chef::Config[:file_cache_path]}/FIT224989_mac10.10_.zip") end
end
...
execute "unzip the xerox550 driver" do
    ...
    not_if do ::File.exists?("#{Chef::Config[:file_cache_path]}/XC_Integrated550_560_v1_1R_EFIGSBpDX_FD47_v1.dmg") end
end
